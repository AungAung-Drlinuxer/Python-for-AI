...
Python က `if` condition ကို အရင်စစ်ပါတယ်။ မှားရင် ပထမ `elif` ကို စစ်ပါတယ်။ အဲဒါလည်း မှားရင် နောက�် `elif` ဆက်စစ်ပါတယ်။ ပထမဆုံး `True` ဖြစ်တဲ့ condition ရှိရင် အဲဒီ block ပဲ အလုပ်လုပ်ပြီး ကျန်တာတွေကို ကျော်ပါတယ်။ အားလုံးမှားရင် `else` block က အလုပ်လုပ်ပါတယ်။
