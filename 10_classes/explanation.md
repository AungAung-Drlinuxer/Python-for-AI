...
တူညီတဲ့ လုပ်ဆောင်ချက်တွေကို နောက်ထပ် ထပ်မရေးရပါ။ Parent class မှာ အထွက် ရေးထားပြီး child class တွေက ငြိမ်ငြိမ် သုံးလို့ရပါတယ်။ Code ထပ်တူများ လျှော့ပြီး ထိန်းသိမ်းမှု လွယ်ပါတယ်။
